...
namespace Lucky_FabianaPadilla.Controllers
{
    ...
    public class SuertesController : ControllerBase
    {
        ...
        // GET: api/Suertes
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Suerte>>> GetLucky_FabianaPadilla()
        {
            return await _context.Lucky_FabianaPadilla.ToListAsync();
        }
        ...
        {
            var suerte = await _context.Lucky_FabianaPadilla.FindAsync(id);
        ...
        {
            _context.Lucky_FabianaPadilla.Add(suerte);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteSuerte(int id)
        {
            ...
            _context.Lucky_FabianaPadilla.Remove(suerte);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Lucky_FabianaPadilla.Any(e => e.SuerteId == id);
        }
    }
}
